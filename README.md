...
Download `SignPDF-1.0.0-macOS-arm64.zip` from the [GitHub Releases page](https://github.com/huwan/SignPDF-macOS/releases), unzip it, and move `SignPDF.app` to `/Applications`.
...
7. Use the toolbar trash button or the signature context menu to delete it.
8. Select **Export** to create the signed PDF.
